    ...
    internal class InitialData
    {
        public static IEnumerable<Customer> Customers =>
            new List<Customer>
            {
                ...
                Customer.Create(CustomerId.Of(new Guid("f3b3b3b3-3b3b-3b3b-3b3b-3b3b3b3b3b3b")), "jane", "mo.Essayed")
            };
        public static IEnumerable<Product> Products =>
            new List<Product>
            {
                ...
                Product.Create(ProductId.Of(new Guid("f3b3b3b3-3b3b-3b3b-3b3b-3b3b3b3b3b3b")), "Sony Xperia", 300)
            };
        public static IEnumerable<Order> OrdersWithItems =>
        new List<Order>
            {
                Order.Create(OrderId.Of(new Guid("f3b3b3b3-3b3b-3b3b-3b3b-3b3b3b3b3b3b")), CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")),
                    new List<OrderItem>
                    {
                        OrderItem.Create(ProductId.Of(new Guid("5334c996-8457-4cf0-815c-ed2b77c4ff61")), 500, 1),
                        OrderItem.Create(ProductId.Of(new Guid("c67d6323-e8b1-4bdf-9a75-b0d0d2e7e914")), 400, 1)
                    }),
                Order.Create(OrderId.Of(new Guid("f3b3b3b3-3b3b-3b3b-3b3b-3b3b3b3b3b3b")), CustomerId.Of(new Guid("189dc8dc-990f-48e0-a37b-e6f2b60b9d7d")),
                    new List<OrderItem>
                    {
                        OrderItem.Create(ProductId.Of(new Guid("4f136e9f-ff8c-4c1f-9a33-d12f689bdab8")), 650, 1),
                        OrderItem.Create(ProductId.Of(new Guid("6ec1297b-ec0a-4aa1-be25-6726e3b51a27")), 450, 1)
                    }),
                Order.Create(OrderId.Of(new Guid("f3b3b3b3-3b3b-3b3b-3b3b-3b3b3b3b3b3b")), CustomerId.Of(new Guid("f3b3b3b3-3b3b-3b3b-3b3b-3b3b3b3b3b3b")),
                    new List<OrderItem>
                    {
                        OrderItem.Create(ProductId.Of(new Guid("f3b3b3b3-3b3b-3b3b-3b3b-3b3b3b3b3b3b")), 300, 1)
                    })
            };
        public static IEnumerable<Order> OrdersWithItems
        {
